...
def upgrade() -> None:
    ...
    sa.Column('recipient_id', sa.Integer(), nullable=False),
    sa.Column('recipient_version_id', sa.Integer(), nullable=False),
    sa.Column('sent_at', sa.DateTime(), nullable=False),
    sa.ForeignKeyConstraint(['postcard_id'], ['postcards.id'], ),
    sa.ForeignKeyConstraint(['recipient_id'], ['recipients.id'], ),
    sa.ForeignKeyConstraint(['recipient_version_id'], ['recipient_versions.id'], ),
    sa.PrimaryKeyConstraint('id'),
    sa.UniqueConstraint('postcard_id', 'recipient_id')
    )
    with op.batch_alter_table('sendings', schema=None) as batch_op:
        batch_op.create_index(batch_op.f('ix_sendings_postcard_id'), ['postcard_id'], unique=False)
        batch_op.create_index(batch_op.f('ix_sendings_recipient_id'), ['recipient_id'], unique=False)
...
def downgrade() -> None:
    # ### commands auto generated by Alembic - please adjust! ###
    with op.batch_alter_table('sendings', schema=None) as batch_op:
        batch_op.drop_index(batch_op.f('ix_sendings_recipient_id'))
        batch_op.drop_index(batch_op.f('ix_sendings_postcard_id'))
